...
from src.library.utils import detect_obj
...
def plot_metrics(metrics, save_to=None):
    # Create the barplot
...
def evaluate_model_on_test_images(model, images_path, num_images=32, save_to=None):
